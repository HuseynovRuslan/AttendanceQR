...
const PAGE_META: Record<string, { title: string; sub: string }> = {
  ...
  '/admin/assets': { title: 'Kompüter inventarizasiyası', sub: 'Hansı avadanlıq kimə təhkim olunub' },
  ...
  const sections: { title: string | null; links: { to: string; label: string; Icon: typeof IconHome }[] }[] = [
    ...
    },
    {
      ...
      links: [
        ...
        ...(isAdmin ? [{ to: '/admin/assets', label: 'Kompüter inventarizasiyası', Icon: IconLaptop }] : []),
