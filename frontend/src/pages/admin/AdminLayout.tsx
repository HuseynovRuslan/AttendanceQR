...
const PAGE_META: Record<string, { title: string; sub: string }> = {
  ...
  '/admin/equipment': { title: 'Kompüter inventarizasiyası', sub: 'İT avadanlıqlarının siyahısı — kimdə nə var' },
  ...
  '/admin/geofence-fit': { title: 'Radius uyğunsuzluğu', sub: 'Filialda dayanıb skan vura bilməyən işçilər' },
  ...
  const sections: { title: string | null; links: { to: string; label: string; Icon: typeof IconHome }[] }[] = [
    ...
    },
    {
      ...
      links: [
        ...
        // Same idea as the row above it, for the other silent misconfiguration: a site whose GPS
        // circle refuses people who are standing at it.
        { to: '/admin/geofence-fit', label: 'Radius uyğunsuzluğu', Icon: IconMapPin },
    ...
    },
    {
      ...
      links: [
        ...
        ...(isAdmin ? [{ to: '/admin/equipment', label: 'Kompüter inventarizasiyası', Icon: IconLaptop }] : []),
